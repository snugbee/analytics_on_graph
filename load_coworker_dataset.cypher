...
MERGE (n)-[r:HAS_JOB{start_date:rows.start_date, end_date:rows.end_date}]->(m);
...
MERGE (n)-[r:WORKS_IN{start_date:rows.start_date, end_date:rows.end_date}]->(d);
...
MERGE (n)-[r:IS_MEMBER_OF{start_date:rows.start_date, end_date:rows.end_date}]->(g);